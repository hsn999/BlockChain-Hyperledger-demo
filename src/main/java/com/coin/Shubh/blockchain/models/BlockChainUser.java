...
public class BlockChainUser implements User, Serializable {
    ...
    private transient LocalKeyStore keyValStore;
    private String keyValStoreName;

    BlockChainUser(String name, String org, LocalKeyStore fs) {
        this.name = name;
    ...
    BlockChainUser restoreState() {
        ...
        if (null != memberStr) {
            ...
            try {
                ...
                BlockChainUser state = (BlockChainUser) ois.readObject();
                if (state != null) {
